...
func (c *fileServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (FileService_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[0], "/file_stream.FileService/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fileServiceClient) DownloadFile(ctx context.Context, in *ServeFileRequest, opts ...grpc.CallOption) (FileService_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[1], "/file_stream.FileService/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}
